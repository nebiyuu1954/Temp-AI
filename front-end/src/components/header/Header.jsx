  ...
  if (!user) {
    ...
    return (
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e6edf4] px-10 py-3">
        ...
        <div className="flex flex-1 justify-end gap-8">
          <div className="flex items-center gap-9">
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="/dashboard">{t('header.home')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('Recommended Internships')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('My Applications')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('Resume Builder')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('Notifications')}</a>
          </div>
          <select
            value={i18n.language}
            onChange={(e) => changeLanguage(e.target.value)}
    ...
    return (
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e6edf4] px-10 py-3">
        ...
        <div className="flex flex-1 justify-end gap-8">
          <div className="flex items-center gap-9">
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="/dashboard">{t('header.home')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('Jobs')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('Candidates')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('Analytics')}</a>
            <a className="text-[#0c141d] text-sm font-medium leading-normal" href="#">{t('Notifications')}</a>
          </div>
          <select
            value={i18n.language}
