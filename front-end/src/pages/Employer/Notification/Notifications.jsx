...
const employerNotifications = [
  {
    id: 1,
    icon: 'File',
    message: 'New application received for Software Engineering Internship position.',
    time: '1d ago',
  },
  {
    id: 2,
    icon: 'Briefcase',
    message: 'Your job posting for Data Analyst Intern has received 15 new applications.',
    time: '2d ago',
  },
  {
    id: 3,
    icon: 'Bell',
    message: 'Reminder: Review pending applications for your UX/UI Design Intern position.',
    time: '3d ago',
  },
  {
    id: 4,
    icon: 'Star',
    message: 'Interview scheduled: Candidate Abebe Kebede for Software Engineer Intern role.',
    time: '1w ago',
  },
  {
    id: 5,
    icon: 'File',
    message: 'Monthly analytics report is now available for your job postings.',
    time: '2w ago',
  },
];
    ...
    <div className="min-h-screen bg-[#f8f9fc]">
      ...
      <div className="gap-1 px-6 flex flex-1 justify-center py-5 relative">
        ...
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          ...
          {employerNotifications.map(({ id, icon, message, time }) => (
